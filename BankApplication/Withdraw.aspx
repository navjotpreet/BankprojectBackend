<%@ Page Title="" Language="C#" MasterPageFile="~/BankMaster.Master" AutoEventWireup="true" CodeBehind="Withdraw.aspx.cs" Inherits="BankApplication.Withdraw" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BankMainContent" runat="server">
    <div class="container adjust-form">
        <div class="form-horizontal">
            <center>
                <h2 class="fix-heading">Withdraw Money</h2>
            </center>
            <br />
            <br />
            <div class="col-md-offset-3 col-md-5 ">
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <asp:Button class="btn btn-success" ID="btnWithdraw" runat="server" Text="Withdraw" OnClick="btnWithdraw_Click" />
                    </div>
                </div>
            </div>
        </div>
